...
The webkit_2.0.bb recipe is immature, and the python.bb recipe is almost empty. This is caused mainly to the time wasted trying to identify the errors given during the recipe creation, and that were caused by the ARM version problems.
